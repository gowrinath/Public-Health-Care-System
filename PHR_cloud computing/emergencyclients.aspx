<%@ Page Language="C#" AutoEventWireup="true" CodeFile="emergencyclients.aspx.cs" Inherits="emergencyclients" %>
    ...
    <div>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <asp:Panel ID="Panel4" runat="server" 
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" style="position:absolute; top: 115px; left: 195px;" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="mailid" HeaderText="Mail ID" ReadOnly="True" />
                         
                        <asp:BoundField DataField="name" HeaderText="Client Name" />
                       
                         <asp:BoundField DataField="secret" HeaderText="Secret Key" />
                       
                        <asp:HyperLinkField HeaderText="Send" Text="send key" DataNavigateUrlFields="mailid" DataNavigateUrlFormatString="~/sendmail.aspx?mailid={0}" />
