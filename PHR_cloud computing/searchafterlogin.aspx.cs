...
public partial class searchafterlogin : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            StreamWriter writer = new StreamWriter(@"D:\yeswanth\dotnet\LSD1209 - Scalable and Secure Sharing\Project code\PHR_cloud computing\privatekey.xml");
            string publicPrivateKeyXML = rsa.ToXmlString(true);
            writer.Write(publicPrivateKeyXML);
            writer.Close();
            //provide public only RSA params	
            writer = new StreamWriter(@"D:\yeswanth\dotnet\LSD1209 - Scalable and Secure Sharing\Project code\PHR_cloud computing\publickey.xml");
            ...
            AssignParameter();
            StreamReader reader = new StreamReader(@"D:\yeswanth\dotnet\LSD1209 - Scalable and Secure Sharing\Project code\PHR_cloud computing\publickey.xml");
            ...
            StreamReader reader1 = new StreamReader(@"D:\yeswanth\dotnet\LSD1209 - Scalable and Secure Sharing\Project code\PHR_cloud computing\privatekey.xml");
    ...
    protected void link_click(object sender, CommandEventArgs e)
    {
        ...
        Response.Redirect("downloadfiles.aspx?id='" + e.CommandName + "'");
    }
