<%@ Page Language="C#" AutoEventWireup="true" CodeFile="downloadfiles1.aspx.cs" Inherits="downloadfiles1" %>
        ...
        <asp:Panel ID="Panel2" runat="server" 
            ...
            <asp:Panel ID="Panel3" runat="server" 
                ...
                <asp:Label ID="Label7" runat="server" Font-Names="Calibri" Font-Size="Medium" 
                    ForeColor="#006699" style="position:absolute; top: 36px; left: 4px;" 
                    Text="Type here to mail id"></asp:Label>
                ...
                <asp:TextBox ID="TextBox2" runat="server" 
                     ...
                     style="position:absolute; top: 35px; left: 153px; height: 22px; width: 151px; bottom: 631px;"></asp:TextBox>
                ...
                <asp:ImageButton ID="ImageButton1" runat="server" 
                    ...
                    style="position:absolute; top: 111px; left: 158px; width: 95px; height: 26px; bottom: 551px;" 
         ...
         <asp:LinkButton ID="LinkButton1" runat="server" 
            style="position:absolute; top: 65px; left: 1095px;" Font-Bold="True" 
