...
public partial class phr_ownerlogin : System.Web.UI.Page
{
    ...
    {
        con.Open();
        SqlDataAdapter sd = new SqlDataAdapter("select skey,pkey,id,name,uname,pwd,role,status from phrownerreg where uname='" + TextBox1.Text + "' and pwd='" + TextBox2.Text + "' and status='"+sta+"'", con);
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                Response.Redirect("phrafterlogin.aspx");
            }
            else
            {
