<%@ Page Language="C#" AutoEventWireup="true" CodeFile="phr ownerlogin.aspx.cs" Inherits="phr_ownerlogin" %>
        ...
        <asp:Panel ID="Panel2" runat="server" 
            ...
            <asp:Panel ID="Panel3" runat="server" BackImageUrl="~/images/loginbg.png" 
                ...
                <asp:Label ID="Label4" runat="server" Font-Names="Calibri" Font-Size="Large" 
                    ForeColor="#003300" style="position:absolute; top: -200px; left: -24px; width: 225px; height: 21px;" 
                    Text="Personal Health Owners Login "></asp:Label>
                ...
                <asp:LinkButton ID="LinkButton1" runat="server" Font-Names="Calibri" 
                    ...
                    PostBackUrl="~/phr ownerregister.aspx">sign up ...</asp:LinkButton>
            </asp:Panel>
