...
public partial class searchusersregisterform : System.Web.UI.Page
{
    ...
    {
        TextBox1.Text = Convert.ToString(cid.createid());
    }
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("insert into searchuserreg values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "','" + TextBox7.Text + "','" + TextBox8.Text + "','" + sta + "','"+Label12.Text+"','"+Label13.Text+"')", con);
        cmd.ExecuteNonQuery();
