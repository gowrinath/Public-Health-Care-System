<%@ Page Language="C#" AutoEventWireup="true" CodeFile="publicaacontent.aspx.cs" Inherits="publicaacontent" %>
    ...
    <div>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <asp:Panel ID="Panel4" runat="server" 
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" style="position:absolute; top: 117px; left: 170px;" 
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="id" HeaderText="PHR Owner ID" ReadOnly="True" />
                         
                        <asp:BoundField DataField="name" HeaderText="Owner Name" />
                       
                         <asp:BoundField DataField="skey" HeaderText="Secret Key" />
                       
                       <asp:BoundField DataField="pkey" HeaderText="Public Key" ReadOnly="True" />
