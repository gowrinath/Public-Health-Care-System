<%@ Page Language="C#" AutoEventWireup="true" CodeFile="phrmaintaindetails.aspx.cs" Inherits="phrmaintaindetails" %>
    ...
    <div>
        ...
        <asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <asp:Panel ID="Panel4" runat="server" 
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" style="position:absolute; top: 122px; left: 74px;" 
                    ...
                    <Columns>
                        <asp:BoundField DataField="oid" HeaderText="User ID" ReadOnly="True" />
                         
                        <asp:BoundField DataField="fname" HeaderText="Upload Files" />
                       
                 <asp:BoundField DataField="filee" HeaderText="Encrypted Text" />
        ...
        <asp:LinkButton ID="LinkButton6" runat="server" 
            style="position:absolute; top: 64px; left: 153px; " 
            Font-Size="Large" Font-Underline="False" ForeColor="#003300" 
            PostBackUrl="~/phrafterlogin.aspx">back</asp:LinkButton>
