<%@ Page Language="C#" AutoEventWireup="true" CodeFile="phr ownerregister.aspx.cs" Inherits="phr_ownerregister" %>
...
<body bgcolor="#B3CAD7">
    ...
    <div>
        <asp:Panel ID="Panel2" runat="server" 
            ...
            <asp:Panel ID="Panel4" runat="server" 
                ...
                <asp:TextBox ID="TextBox7" runat="server" 
                    style="position:absolute; top: 202px; left: 159px;">PHR Owner</asp:TextBox>
        ...
        <asp:LinkButton ID="LinkButton5" runat="server" 
            style="position:absolute; top: 243px; left: 1037px; width: 140px; height: 23px;" 
            Font-Size="Large" Font-Underline="False" ForeColor="#660033" 
            PostBackUrl="~/phr ownerlogin.aspx">back to homepage</asp:LinkButton>
    </div>
    </form>
</body>
</html>
